...
public enum CustVipLevelEnum {
	 ...
	 * 黄金会员
	 */
	GOLD_LEVEL_MEMBER("1000", "黄金会员"),

	/**
	 * 白金会员
	 */
	PLATINUM_LEVEL_MEMBER("1000", "白金会员"),

	/**
	 * 钻石会员
	 */
	DIAMOND_LEVEL_MEMBER("1000", "钻石会员");
	 ...
	 * @return
	 */
	public CustVipLevelEnum getEnumByCode(String levelCode) {
