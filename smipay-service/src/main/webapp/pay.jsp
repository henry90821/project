...
<link href="<%=request.getContextPath()%>/base.css" rel="stylesheet" type="text/css" />
  ...
  <body>
		<br><br><br><br><br><br><br>
		 ...
		 <div>返回值：appId=<%=appId%>   </div>
		 <div>返回值：timeStamp=<%=timeStamp%>   </div>
		  <div>返回值：packageValue=<%=packageValue%>   </div>
		 <div>返回值：nonceStr=<%=nonceStr%>   </div>
		 <div>返回值：paySign=<%=paySign%>   </div>
  			<div style="text-align:center;font-size:30px">
  			<input type="button" style="width:400px;height:200px;" value="微信支付" onclick="callpay()">
  			</div>
