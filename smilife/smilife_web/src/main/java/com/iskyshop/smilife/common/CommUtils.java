...
public class CommUtils {
	public static final Logger logger =Logger.getLogger(CommUtils.class);
	...
	public static String getProperties(String propertiesFile,String key)throws Exception{
		...
		try {
        	...
        	logger.debug(" 获取 Properties文件异常，文件名："+propertiesFile+" 异常信息为："+e);
        	throw e;
        }finally {
			is.close();
		}
	...
	/**
	 * 把数组所有元素排序，并按照“参数=参数值”的模式用“&”字符拼接成字符串。value为null的key，其在返回值中对应的值为空串
	 * 
	 * @param params
	 *            需要排序并参与字符拼接的参数组
	 * @return 拼接后字符串
