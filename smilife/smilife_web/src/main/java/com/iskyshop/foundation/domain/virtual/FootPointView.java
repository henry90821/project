...
public class FootPointView {
	...
	private String fpv_goods_time;
	

	
	public String getFpv_goods_time() {
		return fpv_goods_time;
	}

	public void setFpv_goods_time(String fpv_goods_time) {
		this.fpv_goods_time = fpv_goods_time;
	}
