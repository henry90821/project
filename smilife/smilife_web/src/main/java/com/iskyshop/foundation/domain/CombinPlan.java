...
public class CombinPlan extends IdEntity {
	...
	private String	main_goods_info;	// 组合销售主商品,使用json管理{"id":6,"price":128.00,"inventory":3,"store_price":128.00,"name":"大嘴猴 钥匙圈-心型眼镜系列(7*13CM)","img":"http://img.xingmeihui.com/upload/system/self_goods/6232ddad-e63a-4f33-a925-9e55b186ea2e.jpg_small.jpg","url":"http://192.168.22.80:8080/smilife_web/goods_6.htm"}
	...
	@Column(columnDefinition = "LongText")
	private String	combin_plan_info;	// 组合信息，组合信息中包含多个组合方案信息，每个组合方案中包含一组组合商品信息(不包含主商品信息)，使用json管理（json中保存的内容其实不只这些字段）[{"all_goods_price":567.0,"plan_goods_price":"500","goods_list":[{"id":7,"name":"123"},
										// {"id":8,"name":"测试商品5"}]},
