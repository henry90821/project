...
public class Payment extends IdEntity {
	...
	private String mark;// 支付方式标识代码,alipay为支付宝，
						...
						// tenpay为财付通,balance为预存款，payafter为货到付款(V2.0版本增加商品是否支持货到付款属性，取消该付款方式。即：若要判断订单是否是货到付款，要根据OrderForm的payType的值来判断)，
	...
	// 以下是银联在线信息
	private String chinapay_account;
	...
	@Column(name="alipay_sign_type")
	private String alipaySignType;// 支付宝加密方式
	
	//add by dengyuqi 2015-9-14
	/**
	 * 支付方式对应的logo图标所存位置
	 */
	...
	/**
	 * 支付方式对应的平台(自由组合，如'pc','pc,wap','pc,wap,app')
	 */
	private String terminal_mark;
	//end by dengyuqi 2015-9-14
	...
	public String getChinapay_account() {
		return chinapay_account;
	}

	public void setChinapay_account(String chinapay_account) {
		this.chinapay_account = chinapay_account;
	}
	...
	public String getTerminal_mark()
	{
		return terminal_mark;
	}

	public void setTerminal_mark(String terminal_mark)
	{
		this.terminal_mark = terminal_mark;
	}
