...
public class MutablePropertyValues implements PropertyValues, Serializable {
	...
	/**
	 * Deep copy constructor. Guarantees PropertyValue references are independent, although it can't deep copy objects
	 * currently referenced by individual PropertyValue objects.
	 * 
	 * @param source
	 ...
	 * 
	 * @param source
	 *            Map with property values keyed by property name, which must be a String
	...
	/**
	 * Copy all given PropertyValues into this object. Guarantees PropertyValue references are independent, although it can't
	 * deep copy objects currently referenced by individual PropertyValue objects.
	 * 
	 * @param source
	 *            the PropertyValues to copy
	 * @return this object to allow creating objects, adding multiple PropertyValues in a single statement
	 */
