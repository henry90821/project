...
public class ExcelUtil {
	...
	public static void export2Excel(ExportSetInfo setInfo) throws IOException, IllegalArgumentException,
			...
			for (Object obj : objs) {
				...
				if (fieldNames != null) {
					for (int num = 0; num < fieldNames.length; num++) {
						if (fieldNames[num].indexOf("-") > 0) { //内容拼接
							StringBuffer sb=new StringBuffer();
							String[] dataNames = fieldNames[num].split("-");
							for (int i = 0; i < dataNames.length; i++) {
								Object value = ReflectionUtils.invokeGetterMethod(obj, dataNames[i]);
								sb.append(value.toString());
							}
							cells[cellNum].setCellValue(StringUtils.isNullOrEmpty(sb)? "" : sb.toString());
							cellNum++;
						} else if (fieldNames[num].indexOf("/") > 0) {//取内容存在的,即取不为null
							String[] dataNames = fieldNames[num].split("/");
							 Object object=null;
							for (int i = 0; i < dataNames.length; i++) {
								Object value = ReflectionUtils.invokeGetterMethod(obj, dataNames[i]);
							...
							cells[cellNum].setCellValue(StringUtils.isNullOrEmpty(object) ? "" : object.toString());
							cellNum++;
						} else {
							Object value = ReflectionUtils.invokeGetterMethod(obj, fieldNames[num]);
							cells[cellNum].setCellValue(StringUtils.isNullOrEmpty(value) ? "" : value.toString());
							cellNum++;
						}
					}
				}
	 ...
	 */
	public static void createTableTitleRow(ExportSetInfo setInfo, HSSFSheet[] sheets, int sheetNum) {
	 ...
	 */
	public static void createTableDateRow(ExportSetInfo setInfo, HSSFSheet[] sheets, int sheetNum) {
	 ...
	 */
	public static void creatTableHeadRow(ExportSetInfo setInfo, HSSFSheet[] sheets, int sheetNum) {
		// 表头
	 ...
	 */
	public static HSSFSheet[] getSheets(int num, String[] names) {
	 ...
	 */
	public static void initTitleCellStyle() {
	 ...
	 */
	public static void initDateCellStyle() {
	 ...
	 */
	public static void initHeadCellStyle() {
	 ...
	 */
	public static void initContentCellStyle() {
	 ...
	 */
	public static void initTitleFont() {
	 ...
	 */
	public static void initDateFont() {
	 ...
	 */
	public static void initHeadFont() {
	 ...
	 */
	public static void initContentFont() {
