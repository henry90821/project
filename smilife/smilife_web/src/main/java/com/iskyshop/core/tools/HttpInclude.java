 ...
 * 
 * <p>
 * Description:完成于jsp:include page 相同的功能,用于include其它页面以用于布局,可以用于在freemarker, velocity的servlet环境应用中直接include其它http请求
 * </p>
 * 
 * <p>
...
public class HttpInclude {
	private static Logger logger = Logger.getLogger(HttpInclude.class);
	...
	private void getLocalContent(String includePath, Writer writer) throws ServletException, IOException {
		...
		CustomOutputHttpServletResponseWrapper customResponse = new CustomOutputHttpServletResponseWrapper(response, writer,
				outputStream);
