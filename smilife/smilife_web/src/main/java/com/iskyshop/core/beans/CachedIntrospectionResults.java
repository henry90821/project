...
final class CachedIntrospectionResults {
	...
	private static Logger logger = Logger.getLogger(CachedIntrospectionResults.class);

	/**
	 * Map keyed by class containing CachedIntrospectionResults. Needs to be a WeakHashMap with WeakReferences as values to
	 * allow for proper garbage collection in case of multiple class loaders.
	 */
	 ...
	 * <P>
	 * We don't want to use synchronization here. Object references are atomic, so we can live with doing the occasional
	...
	/**
	 * Check whether the given class is cache-safe, i.e. whether it is loaded by the same class loader as the
	 * CachedIntrospectionResults class or a parent of it.
	 * <p>
	 * Many thanks to Guillaume Poirier for pointing out the garbage collection issues and for suggesting this solution.
	 * 
	 * @param clazz
