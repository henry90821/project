...
public class CharacterEditor extends PropertyEditorSupport {
	 ...
	 * <p>
	 * The "allowEmpty" parameter controls whether an empty String is to be allowed in parsing, i.e. be interpreted as the
	 * <code>null</code> value when {@link #setAsText(String) text is being converted}. If <code>false</code>, an
