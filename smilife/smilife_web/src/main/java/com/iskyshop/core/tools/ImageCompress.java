...
public class ImageCompress extends Frame {
	...
	public static void main(String[] args) {
		...
		if ("gui".equals(gui)) {
			...
			ImageCompress.ImageScale(fileName, fileName + "-s." + getFileExt(fileName).toLowerCase(), 160, 160);
			logger.info("elapse time:" + (System.currentTimeMillis() - c) / 1000.0f + "s");
		}
	}
	...
	/**
	 * createUI() creates the user controls and lays out the window. It also creates the event handlers (as inner classes)
