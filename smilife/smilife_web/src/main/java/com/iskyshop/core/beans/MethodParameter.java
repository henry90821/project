...
/**
 * Helper class that encapsulates the specification of a method parameter, that is, a Method or Constructor plus a parameter
 * index. Useful as a specification object to pass along.
 * 
 * <p>
...
public class MethodParameter {
	...
	public MethodParameter(Constructor constructor, int parameterIndex) {
		...
		Assert.isTrue(parameterIndex >= 0, "Parameter index must not be negative");
		Assert.isTrue(parameterIndex < constructor.getParameterTypes().length, "Parameter index must not exceed "
	 ...
	 * <p>
	 * This is a convenience constructor for scenarios where a Method or Constructor reference is treated in a generic
	 * fashion.
	 * 
