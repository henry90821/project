 ...
 * 
 * <p>
 * Mainly intended for usage within the framework, determining the target type of values to be added to a collection or map
 * (to be able to attempt type conversion if appropriate).
 * 
 * <p>
 * Only usable on Java 5. Use an appropriate JdkVersion check before calling this class, if a fallback for JDK 1.3/1.4 is
 * desirable.
 * 
...
public abstract class GenericCollectionTypeResolver {
	 ...
	 * @param typeIndex
	 *            the index of the type (e.g. 0 for Collections, 0 for Map keys, 1 for Map values)
	 * @return the generic type, or <code>null</code> if none
	 */
	 ...
	 * 
	 * @param ptype
	 *            the ParameterizedType to check
	 * @param typeIndex
	 *            the index of the actual type argument
	 * @return the generic type as Class, or <code>null</code> if none
	 */
