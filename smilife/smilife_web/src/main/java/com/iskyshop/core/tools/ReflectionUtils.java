 ...
 * @Description: TODO(提供访问私有变量,获取泛型类型Class, 提取集合中元素的属性, 转换字符串到对象等Util函数.)
 * @author wangyun
 * @date 2015-10-13
 * 
 */
public class ReflectionUtils {
	...
	public static Object invokeMethod(final Object object, final String methodName, final Class<?>[] parameterTypes,
		...
		if (method == null) {
			throw new IllegalArgumentException("Could not find method [" + methodName + "] parameterType " + parameterTypes
					+ " on target [" + object + "]");
		}
	 ...
	 */
	public static void copyPorperties(Object dest, Object source, String[] porperties) throws InvocationTargetException,
