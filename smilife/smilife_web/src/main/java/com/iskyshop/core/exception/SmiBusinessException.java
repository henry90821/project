...
/**
 * 业务异常基类。 Created by Andriy on 15/7/1.
 */
public class SmiBusinessException extends RuntimeException {
	 ...
	 * @since 1.4
	 */
	public SmiBusinessException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @since 1.4
	 */
	public SmiBusinessException(Throwable cause) {
		super(cause);
	}
	 ...
	 * @since 1.7
	 */
	public SmiBusinessException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
