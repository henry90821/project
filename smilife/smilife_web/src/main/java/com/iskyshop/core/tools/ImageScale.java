...
public class ImageScale {
	private static Logger logger = Logger.getLogger(ImageScale.class);
	private int width;
	private int height;
	...
	/** */
	/**
	 * Start: Use Lanczos filter to replace the original algorithm for image scaling. Lanczos improves quality of the scaled
	 * image modify by :blade
	 */
