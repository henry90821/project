...
/**
 * Created by 亚翔 on 2015/9/10.
 */
public class PayValidationException extends SmiBusinessException {
	 ...
	 * @since 1.7
	 */
	public PayValidationException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
