...
public class InformationManageAction {
	...
	public ModelAndView information_head_list(HttpServletRequest request, HttpServletResponse response, String type,
			String currentPage, String title, String author, String classid) {
		ModelAndView mv = new JModelAndView("admin/blue/information_head_list.html", configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		InformationQueryObject qo = new InformationQueryObject(currentPage, mv, "sequence,addTime", "desc");
	...
	public ModelAndView information_head_save(HttpServletRequest request, HttpServletResponse response, String id,
			String currentPage) {
		ModelAndView mv = null;
		Information infor = this.informationService.getObjById(CommUtil.null2Long(id));
		if (infor != null) {
			Map map = new HashMap();
			map.put("status", 20);
			map.put("recommend", 1);
			List<Information> informations = this.informationService.query(
					"select obj from Information obj where obj.status=:status and obj.recommend=:recommend", map, -1, -1);
			...
			mv = new JModelAndView("admin/blue/success.html", configService.getSysConfig(),
					this.userConfigService.getUserConfig(), 0, request, response);
			mv.addObject("list_url", CommUtil.getURL(request) + "/admin/cms_template_list.htm");
			mv.addObject("op_title", "设置首页头部成功");
			mv.addObject("add_url",
					CommUtil.getURL(request) + "/admin/information_head_list.htm?currentPage=" + currentPage);
		} else {
	...
	public ModelAndView information_list(HttpServletRequest request, HttpServletResponse response, String currentPage,
		...
		ModelAndView mv = new JModelAndView("admin/blue/information_list.html", configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		InformationQueryObject qo = new InformationQueryObject(currentPage, mv, "sequence,addTime", "desc");
		qo.addQuery("obj.status", new SysMap("status", 20), "=");
		if (!StringUtils.isNullOrEmpty(title)) {
		...
		if (!StringUtils.isNullOrEmpty(CommUtil.null2String(classid))) {
			Map map = new HashMap();
			map.put("id", CommUtil.null2Long(classid));
			List<InformationClass> informationClasses = this.informationClassService
					.query("select obj from InformationClass obj where obj.ic_pid=:id", map, -1, -1);
	...
	public ModelAndView information_verifylist(HttpServletRequest request, HttpServletResponse response, String currentPage,
			String title, String author, String classid) {
		ModelAndView mv = new JModelAndView("admin/blue/information_verifylist.html", configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		...
		if (!StringUtils.isNullOrEmpty(classid)) {
			qo.addQuery("obj.classid", new SysMap("classid", CommUtil.null2Long(classid)), "=");
			mv.addObject("classid", classid);
		}
		IPageList pList = this.informationService.list(qo);
		CommUtil.saveIPageList2ModelAndView("", "", "", pList, mv);
	...
	public ModelAndView information_add(HttpServletRequest request, HttpServletResponse response, String currentPage) {
		ModelAndView mv = new JModelAndView("admin/blue/information_add.html", configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		List<InformationClass> infoclass = this.informationClassService
				.query("select obj from InformationClass obj where obj.ic_pid is null", null, -1, -1);
		mv.addObject("infoclass", infoclass);
	...
	public ModelAndView information_save(HttpServletRequest request, HttpServletResponse response, String id,
		...
		if (StringUtils.isNullOrEmpty(id)) {
			...
			Information obj = this.informationService.getObjById(Long.parseLong(id));
		...
		try {
			...
			if (StringUtils.isNullOrEmpty(fileName)) {
				if (map.get("fileName") != "") {
					...
					photo.setPath(this.FTPTools.userUpload(photo.getName(), "/cover", CommUtil.null2String(user.getId())));
	...
	public ModelAndView information_verify(HttpServletRequest request, HttpServletResponse response, String id,
			String currentPage) {
		ModelAndView mv = new JModelAndView("admin/blue/information_verify.html", configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		if (!StringUtils.isNullOrEmpty(id)) {
			Information obj = this.informationService.getObjById(Long.parseLong(id));
			mv.addObject("className", this.informationClassService.getObjById(obj.getClassid()).getIc_name());
	...
	public String verify_save(HttpServletRequest request, HttpServletResponse response, String id, String currentPage,
	...
	public String stick(HttpServletRequest request, HttpServletResponse response, String id, String currentPage) {
		ModelAndView mv = new JModelAndView("admin/blue/information_add.html", configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		if (!StringUtils.isNullOrEmpty(id)) {
			Information information = this.informationService.getObjById(Long.parseLong(id));
	...
	public ModelAndView info_preview(HttpServletRequest request, HttpServletResponse response, String id) {
		...
		if (info != null) {
			...
			List<Information> before = this.informationService.query(
					"select obj from Information obj where obj.addTime>:addTime and obj.status=20 order by addTime asc", map,
					0, 1);
			if (before.size() > 0) {
	...
	public ModelAndView cms_template_list(HttpServletRequest request, HttpServletResponse response, String currentPage,
			String title, String author, String classid) {
		ModelAndView mv = new JModelAndView("admin/blue/cms_template_list.html", configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);

		String params = "";
		CmsIndexTemplateQueryObject qo = new CmsIndexTemplateQueryObject(currentPage, mv, "sequence", "asc");
		WebForm wf = new WebForm();
		wf.toQueryPo(request, qo, CmsIndexTemplate.class, mv);
		IPageList pList = this.cmsIndexTemplateService.list(qo);
		CommUtil.saveIPageList2ModelAndView(CommUtil.getURL(request) + "/admin/cms_template_list.htm", "", params, pList, mv);
		Map map = new HashMap();
		map.put("status", 20);
		map.put("recommend", 1);
		List<Information> informations = this.informationService
				.query("select obj from Information obj where obj.status=:status and obj.recommend=:recommend", map, -1, -1);
	...
	public ModelAndView cms_template_edit(HttpServletRequest request, HttpServletResponse response, String id,
			String currentPage) {
		ModelAndView mv = new JModelAndView("admin/blue/cms_template_add.html", configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		if (!StringUtils.isNullOrEmpty(id)) {
			CmsIndexTemplate cmsindextemplate = this.cmsIndexTemplateService.getObjById(Long.parseLong(id));
	...
	public ModelAndView cms_template_save(HttpServletRequest request, HttpServletResponse response, String id,
			String currentPage, String cmd, String list_url, String add_url) {
		WebForm wf = new WebForm();
		...
		if (StringUtils.isNullOrEmpty(id)) {
			...
			CmsIndexTemplate obj = this.cmsIndexTemplateService.getObjById(Long.parseLong(id));
	...
	public ModelAndView cms_template_add(HttpServletRequest request, HttpServletResponse response, String type) {
		ModelAndView mv = new JModelAndView("admin/blue/cms_template_add.html", configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
	...
	public ModelAndView cms_template_draw(HttpServletRequest request, HttpServletResponse response, String id) {
		ModelAndView mv = new JModelAndView("admin/blue/cms_template_draw.html", configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		if (!StringUtils.isNullOrEmpty(id)) {
			CmsIndexTemplate cmsindextemplate = this.cmsIndexTemplateService.getObjById(Long.parseLong(id));
			mv.addObject("obj", cmsindextemplate);
	...
	public String cms_template_del(HttpServletRequest request, HttpServletResponse response, String mulitId,
			String currentPage) {
		String[] ids = mulitId.split(",");
		for (String id : ids) {
			if (!StringUtils.isNullOrEmpty(id)) {
	...
	public ModelAndView cms_template_class(HttpServletRequest request, HttpServletResponse response, String currentPage,
			String id) {
		ModelAndView mv = new JModelAndView("admin/blue/cms_template_class.html", configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		CmsIndexTemplate cmsindextemplate = this.cmsIndexTemplateService.getObjById(Long.parseLong(id));
		List<GoodsClass> gcs = this.goodsClassService
				.query("select obj from GoodsClass obj where obj.parent.id is null order by obj.sequence asc", null, -1, -1);
	...
	public ModelAndView cms_template_class_load(HttpServletRequest request, HttpServletResponse response, String currentPage,
			String gc_id) {
		ModelAndView mv = new JModelAndView("admin/blue/cms_template_class_load.html", configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
	...
	public String cms_template_class_save(HttpServletRequest request, HttpServletResponse response, String id, String ids) {
		CmsIndexTemplate obj = this.cmsIndexTemplateService.getObjById(Long.parseLong(id));
		...
		for (String t_id : id_list) {
			...
			if (!StringUtils.isNullOrEmpty(map.get("pid").toString()))
				gf_gc_list.add(map);
		}
	...
	public ModelAndView cms_template_goods(HttpServletRequest request, HttpServletResponse response, String currentPage,
			String id, String count) {
		ModelAndView mv = new JModelAndView("admin/blue/cms_template_goods.html", configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		CmsIndexTemplate cmsindextemplate = this.cmsIndexTemplateService.getObjById(Long.parseLong(id));
		List<GoodsClass> gcs = this.goodsClassService
				.query("select obj from GoodsClass obj where obj.parent.id is null order by obj.sequence asc", null, -1, -1);
	...
	public ModelAndView cms_template_goods_load(HttpServletRequest request, HttpServletResponse response, String currentPage,
			String gc_id, String goods_name, String page, String module_id) {
		ModelAndView mv = new JModelAndView("admin/blue/cms_template_goods_load.html", configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		...
		qo.addQuery("obj.goods_status", new SysMap("goods_status", 0), "=");
		IPageList pList = this.goodsService.list(qo);
		CommUtil.saveIPageList2ModelAndView(CommUtil.getURL(request) + "/admin/cms_template_goods_load.htm", "",
	...
	public String cms_template_goods_save(HttpServletRequest request, HttpServletResponse response, String list_title,
	...
	public ModelAndView cms_template_info(HttpServletRequest request, HttpServletResponse response, String currentPage,
			String id, String count, String type) {
		ModelAndView mv = new JModelAndView("admin/blue/cms_template_info.html", configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		CmsIndexTemplate cmsindextemplate = this.cmsIndexTemplateService.getObjById(Long.parseLong(id));
		List<InformationClass> ics = this.informationClassService.query(
				"select obj from InformationClass obj where obj.ic_pid is null order by obj.ic_sequence asc", null, -1, -1);
	...
	public ModelAndView cms_template_info_load(HttpServletRequest request, HttpServletResponse response, String currentPage,
			String ic_id, String info_name, String page, String module_id) {
		ModelAndView mv = new JModelAndView("admin/blue/cms_template_info_load.html", configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		if (!"".equals(CommUtil.null2String(page))) {
			mv = new JModelAndView("admin/blue/" + page + ".html", configService.getSysConfig(),
					this.userConfigService.getUserConfig(), 0, request, response);
		...
		InformationQueryObject qo = new InformationQueryObject(currentPage, mv, "addTime", "desc");
		qo.setPageSize(14);
		if (!"".equals(CommUtil.null2String(ic_id))) {
			Set<Long> ids = this.genericIds(this.informationClassService.getObjById(CommUtil.null2Long(ic_id)));
			Map paras = new HashMap();
			paras.put("ids", ids);
			qo.addQuery("obj.classid in (:ids)", paras);
		}
		if (!"".equals(CommUtil.null2String(info_name))) {
			qo.addQuery("obj.title", new SysMap("title", "%" + info_name + "%"), "like");
		}
		qo.addQuery("obj.status", new SysMap("status", 20), "=");
		IPageList pList = this.informationService.list(qo);
		CommUtil.saveIPageList2ModelAndView(CommUtil.getURL(request) + "/admin/cms_template_info_load.htm", "",
				"&ic_id=" + ic_id + "&info_name=" + info_name, pList, mv);
		mv.addObject("module_id", module_id);
		mv.addObject("imageTools", imageTools);
		return mv;
	}
	...
	public String cms_template_info_save(HttpServletRequest request, HttpServletResponse response, String list_title,
			String id, String ids, String type) {
		CmsIndexTemplate obj = this.cmsIndexTemplateService.getObjById(Long.parseLong(id));
		String[] id_list = ids.split(",");
		Map map = new HashMap();
		map.put("list_title", list_title);
	...
	public ModelAndView goods_floor_brand(HttpServletRequest request, HttpServletResponse response, String id) {
		ModelAndView mv = new JModelAndView("admin/blue/cms_template_brand.html", configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		CmsIndexTemplate obj = this.cmsIndexTemplateService.getObjById(Long.parseLong(id));
		...
		CommUtil.saveIPageList2ModelAndView(CommUtil.getURL(request) + "/admin/cms_template_brand_load.htm", "", "", pList,
				mv);
		mv.addObject("obj", obj);
		mv.addObject("gf_tools", this.gf_tools);
		return mv;
	...
	public ModelAndView cms_template_brand_load(HttpServletRequest request, HttpServletResponse response, String currentPage,
			String name) {
		ModelAndView mv = new JModelAndView("admin/blue/cms_template_brand_load.html", configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		...
		IPageList pList = this.goodsBrandService.list(qo);
		CommUtil.saveIPageList2ModelAndView(CommUtil.getURL(request) + "/admin/cms_template_brand_load.htm", "",
	...
	public ModelAndView cms_template_free(HttpServletRequest request, HttpServletResponse response, String id,
			String currentPage, String count) {
		ModelAndView mv = new JModelAndView("admin/blue/cms_template_free.html", configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		CmsIndexTemplate cmsindextemplate = this.cmsIndexTemplateService.getObjById(Long.parseLong(id));
		List<FreeClass> fcs = this.freeClassService.query("select obj from FreeClass obj  order by obj.sequence asc", null,
				-1, -1);
	...
	public String cms_template_free_save(HttpServletRequest request, HttpServletResponse response, String id, String ids) {
		CmsIndexTemplate obj = this.cmsIndexTemplateService.getObjById(Long.parseLong(id));
		String[] id_list = ids.split(",");
		Map map = new HashMap();
		for (int i = 0; i < id_list.length; i++) {
	...
	public ModelAndView cms_template_free_load(HttpServletRequest request, HttpServletResponse response, String currentPage,
			String name, String page, String fc_id, String free_name, String module_id) {
		ModelAndView mv = new JModelAndView("admin/blue/cms_template_free_load.html", configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		if (!"".equals(CommUtil.null2String(page))) {
			mv = new JModelAndView("admin/blue/" + page + ".html", configService.getSysConfig(),
					this.userConfigService.getUserConfig(), 0, request, response);
		}
		FreeGoodsQueryObject qo = new FreeGoodsQueryObject(currentPage, mv, "addTime", "desc");
		qo.setPageSize(14);
		if (!"".equals(CommUtil.null2String(fc_id))) {
			Map paras = new HashMap();
			paras.put("fc_id", CommUtil.null2Long(fc_id));
			qo.addQuery("obj.class_id=:fc_id", paras);
		}
		if (!"".equals(CommUtil.null2String(free_name))) {
			qo.addQuery("obj.free_name", new SysMap("free_name", "%" + free_name + "%"), "like");
		}
		qo.addQuery("obj.freeStatus", new SysMap("freeStatus", 5), "=");
		IPageList pList = this.freeGoodsService.list(qo);
		CommUtil.saveIPageList2ModelAndView(CommUtil.getURL(request) + "/admin/cms_template_free_load.htm", "",
				"&fc_id=" + fc_id + "&free_name=" + free_name, pList, mv);
		mv.addObject("module_id", module_id);
		return mv;
	}
	...
	public ModelAndView cms_template_circle(HttpServletRequest request, HttpServletResponse response, String id,
			String currentPage, String count) {
		ModelAndView mv = new JModelAndView("admin/blue/cms_template_circle.html", configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		CmsIndexTemplate cmsindextemplate = this.cmsIndexTemplateService.getObjById(Long.parseLong(id));
		List<CircleClass> ccs = this.circleClassService.query("select obj from CircleClass obj  order by obj.sequence asc",
				null, -1, -1);
	...
	public String cms_template_circle_save(HttpServletRequest request, HttpServletResponse response, String id, String ids) {
		CmsIndexTemplate obj = this.cmsIndexTemplateService.getObjById(Long.parseLong(id));
		String[] id_list = ids.split(",");
		Map map = new HashMap();
		for (int i = 0; i < id_list.length; i++) {
	...
	public ModelAndView cms_template_circle_load(HttpServletRequest request, HttpServletResponse response,
			String currentPage, String name, String page, String cc_id, String circle_name, String module_id) {
		ModelAndView mv = new JModelAndView("admin/blue/cms_template_circle_load.html", configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		if (!"".equals(CommUtil.null2String(page))) {
			mv = new JModelAndView("admin/blue/" + page + ".html", configService.getSysConfig(),
					this.userConfigService.getUserConfig(), 0, request, response);
		}
		CircleQueryObject qo = new CircleQueryObject(currentPage, mv, "addTime", "desc");
		qo.setPageSize(14);
		if (!"".equals(CommUtil.null2String(cc_id))) {
			Map paras = new HashMap();
			paras.put("cc_id", CommUtil.null2Long(cc_id));
			qo.addQuery("obj.class_id=:cc_id", paras);
		}
		if (!"".equals(CommUtil.null2String(circle_name))) {
			qo.addQuery("obj.title", new SysMap("circle_name", "%" + circle_name + "%"), "like");
		}
		qo.addQuery("obj.status", new SysMap("status", 5), "=");
		IPageList pList = this.circleService.list(qo);
		CommUtil.saveIPageList2ModelAndView(CommUtil.getURL(request) + "/admin/cms_template_free_load.htm", "",
				"&cc_id=" + cc_id + "&circle_name=" + circle_name, pList, mv);
		mv.addObject("module_id", module_id);
		mv.addObject("circleViewTools", circleViewTools);
		return mv;
	}
	...
	private Set<Long> genericIds(InformationClass ic) {
		...
		List<InformationClass> ics = this.informationClassService
				.query("select obj from InformationClass obj where obj.ic_pid=:pid", params, -1, -1);
