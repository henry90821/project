...
public class CircleAspect {
	...
	public void circle_aspect(JoinPoint joinPoint, HttpServletRequest request, HttpServletResponse response)
			throws IOException {
		if (!"circle_error".equals(joinPoint.getSignature().getName())) {
