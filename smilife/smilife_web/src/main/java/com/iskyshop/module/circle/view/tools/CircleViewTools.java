...
public class CircleViewTools {
	...
	public Map genercircleImage(String cid) {
		...
		if (obj != null && !"".equals(CommUtil.null2String(obj.getPhotoInfo()))) {
	...
	public String generInvitationParise(String id, String uid) {
		String ret = "false";
		CircleInvitation invit = this.invitationService.getObjById(CommUtil.null2Long(id));
		String temp = "," + uid + ",";
		if (!StringUtils.isNullOrEmpty(invit.getPraiseInfo())) {
