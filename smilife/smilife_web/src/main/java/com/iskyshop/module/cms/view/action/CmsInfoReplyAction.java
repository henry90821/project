...
public class CmsInfoReplyAction {
	...
	public void reply_save(HttpServletRequest request,
		...
		if (acc == null) {
			reply.setUserPhoto(CommUtil.getURL(request)
					+ "/resources/style/system/front/default/images/usercenter/base_person.jpg");
		} else {
	...
	public ModelAndView reply_ajax(HttpServletRequest request,
		...
		Information information = this.informationService.getObjById(CommUtil
				.null2Long(info_id));
