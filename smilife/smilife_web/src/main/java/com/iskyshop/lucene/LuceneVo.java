...
public class LuceneVo {
	...
	public static final String	SECKILL_BUY		= "seckill_buy";
	...
	private String				vo_type;								// 索引类型，商品为goods，店铺为store
																		// ,生活购为lifegoods
	...
	private int					vo_goods_type;							// 商品类型
																		// 0-自营
																		// 1-第三方经营
	...
	private int					vo_whether_active;						// 搜索时显示是否为活动
																		// 0为无活动
																		// 1为团购,2为活动，3为满送，4为满减，5为组合，6为F码，7为预售。
	private int					vo_f_sale_type;						// 是否为F码销售商品，0为不是F码销售商品，1为F码销售商品
	private int					seckill_buy;							// 秒杀状态
	private String				vo_goods_config;						// 商品编码
	...
	/**
	 * @return vo_goods_config
	 */

	public String getVo_goods_config() {
		return vo_goods_config;
	}

	/**
	 * @param vo_goods_config
	 *            the vo_goods_config to set
	 */

	public void setVo_goods_config(String vo_goods_config) {
		this.vo_goods_config = vo_goods_config;
	}
