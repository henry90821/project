...
public class ExpressInfoServiceImpl implements IExpressInfoService {
	...
	public IPageList list(IQueryObject properties) {
		...
		GenericPageList pList = new GenericPageList(ExpressInfo.class, construct, query, params, this.expressInfoDao);
		if (properties != null) {
	...
	@Override
	public ExpressInfo getObjByPropertyWithType(String propertyName, Object value, int order_type) {
		// TODO Auto-generated method stub
		Map params = new HashMap();
		params.put("order_type", order_type);
		params.put("value", value);
		List<ExpressInfo> eis = this.expressInfoDao.query(
				"select obj from ExpressInfo obj where obj.order_type=:order_type and obj." + propertyName + "=:value",
				params, -1, -1);
		if (eis.size() > 0) {
			return eis.get(0);
		} else {
