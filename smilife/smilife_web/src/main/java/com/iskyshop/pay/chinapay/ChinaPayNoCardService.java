...
public class ChinaPayNoCardService {
	private static final Logger LOGGER = Logger.getLogger(ChinaPayNoCardService.class);
	...
	public static String getPayFormStr(String url, Payment payment, String out_trade_no, String body, String total_fee,
			String paySource,String trade_order_id,String subtransdate){
		...
		String str=merId+ordId+transAmt+curyId+transDate+transType+priv1;
