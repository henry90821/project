...
public class AlipayService {
	...
	public static String create_direct_pay_by_user(AlipayConfig config, Map<String, String> sParaTemp)
		...
		// TODO 根据支付宝最新API文档所述需要加入以下不能为空的参数
		sParaTemp.put("seller_id", config.getPartner());

		String strButtonName = "确认";

		return AlipaySubmit.buildForm(config, sParaTemp, ALIPAY_GATEWAY_NEW, "post", strButtonName);
	}
	 ...
	 */
	public static String query_timestamp(AlipayConfig config) throws MalformedURLException, DocumentException, IOException {
	...
	public static String create_partner_trade_by_buyer(AlipayConfig config, Map<String, String> sParaTemp)
		...
		return AlipaySubmit.buildForm(config, sParaTemp, ALIPAY_GATEWAY_NEW, "get", strButtonName);
	}
