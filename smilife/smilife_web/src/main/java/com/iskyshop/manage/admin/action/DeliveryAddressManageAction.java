...
public class DeliveryAddressManageAction {
	...
	public ModelAndView delivery_address_list(HttpServletRequest request, HttpServletResponse response, String currentPage,
			String orderBy, String orderType, String da_name, String da_contact_user, String da_type) {
		ModelAndView mv = new JModelAndView("admin/blue/delivery_address_list.html", configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		DeliveryAddressQueryObject qo = new DeliveryAddressQueryObject(currentPage, mv, orderBy, orderType);
		if (!StringUtils.isNullOrEmpty(da_name)) {
			qo.addQuery("obj.da_name", new SysMap("da_name", "%" + da_name + "%"), "like");
			mv.addObject("da_name", da_name);
		}
		if (!StringUtils.isNullOrEmpty(da_contact_user)) {
			qo.addQuery("obj.da_contact_user", new SysMap("da_contact_user", "%" + da_contact_user + "%"), "like");
			mv.addObject("da_contact_user", da_contact_user);
		}
		if (!StringUtils.isNullOrEmpty(da_type)) {
			qo.addQuery("obj.da_type", new SysMap("da_type", CommUtil.null2Int(da_type)), "=");
	...
	public ModelAndView delivery_apply_list(HttpServletRequest request, HttpServletResponse response, String currentPage,
			String orderBy, String orderType) {
		ModelAndView mv = new JModelAndView("admin/blue/delivery_apply_list.html", configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		DeliveryAddressQueryObject qo = new DeliveryAddressQueryObject(currentPage, mv, orderBy, orderType);
	...
	public ModelAndView delivery_apply_audit(HttpServletRequest request, HttpServletResponse response, String id,
			String currentPage) {
		ModelAndView mv = new JModelAndView("admin/blue/delivery_address_view.html", configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
	...
	public String delivery_apply_refuse(HttpServletRequest request, HttpServletResponse response, String id,
			String currentPage) {
		DeliveryAddress deliveryAddress = this.deliveryAddressService.getObjById(CommUtil.null2Long(id));
	...
	public String delivery_apply_pass(HttpServletRequest request, HttpServletResponse response, String id,
			String currentPage) {
		DeliveryAddress deliveryAddress = this.deliveryAddressService.getObjById(CommUtil.null2Long(id));
		if (deliveryAddress != null) {
	...
	public ModelAndView delivery_address_view(HttpServletRequest request, HttpServletResponse response, String id,
			String currentPage) {
		ModelAndView mv = new JModelAndView("admin/blue/delivery_address_view.html", configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		DeliveryAddress deliveryAddress = this.deliveryAddressService.getObjById(CommUtil.null2Long(id));
	...
	public ModelAndView delivery_address_add(HttpServletRequest request, HttpServletResponse response) {
		ModelAndView mv = new JModelAndView("admin/blue/delivery_address_add.html", configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
	...
	public ModelAndView delivery_address_edit(HttpServletRequest request, HttpServletResponse response, String id) {
		ModelAndView mv = new JModelAndView("admin/blue/delivery_address_add.html", configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		DeliveryAddress deliveryAddress = this.deliveryAddressService.getObjById(CommUtil.null2Long(id));
		mv.addObject("obj", deliveryAddress);
	...
	public ModelAndView delivery_address_save(HttpServletRequest request, HttpServletResponse response, String id,
			String add_url, String list_url, String area3, String da_begin_time, String da_end_time, String da_service_day) {
	...
	public String delivery_address_del(HttpServletRequest request, HttpServletResponse response, String id,
			String currentPage) {
		DeliveryAddress deliveryAddress = this.deliveryAddressService.getObjById(CommUtil.null2Long(id));
		if (deliveryAddress != null) {
	...
	private void remove_deliveryAddress_userRole(Long user_id) {
		...
		if (user != null) {
			...
			for (Role role : user.getRoles()) {
				if (!"DELIVERY".equals(role.getType())) {
					newRoles.add(role);
				}
			}
			user.getRoles().clear();
