...
public class ConsultManageAction {
	...
	public ModelAndView list(HttpServletRequest request, HttpServletResponse response, String currentPage, String orderBy,
			String orderType, String consult_user_userName, String consult_content) {
		ModelAndView mv = new JModelAndView("admin/blue/consult_list.html", configService.getSysConfig(),
	...
	public String delete(HttpServletRequest request, HttpServletResponse response, String mulitId, String currentPage) {
		...
		for (String id : ids) {
			if (!StringUtils.isNullOrEmpty(id)) {
				Consult consult = this.consultService.getObjById(Long.parseLong(id));
