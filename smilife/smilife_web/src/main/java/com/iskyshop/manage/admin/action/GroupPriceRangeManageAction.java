...
public class GroupPriceRangeManageAction {
	...
	public ModelAndView list(HttpServletRequest request, HttpServletResponse response, String currentPage, String orderBy,
			String orderType) {
		ModelAndView mv = new JModelAndView("admin/blue/group_price_list.html", configService.getSysConfig(),
		...
		CommUtil.saveIPageList2ModelAndView(CommUtil.getURL(request) + "/admin/group_range_list.htm", "", params, pList, mv);
		return mv;
	}
	...
	public ModelAndView add(HttpServletRequest request, HttpServletResponse response, String currentPage) {
		ModelAndView mv = new JModelAndView("admin/blue/group_price_add.html", configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
	...
	public ModelAndView edit(HttpServletRequest request, HttpServletResponse response, String id, String currentPage) {
		...
		if (!StringUtils.isNullOrEmpty(id)) {
			GroupPriceRange grouppricerange = this.grouppricerangeService.getObjById(Long.parseLong(id));
