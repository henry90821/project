...
public class ConsultBuyerAction {
	...
	public ModelAndView consult(HttpServletRequest request, HttpServletResponse response, String reply, String currentPage) {
		ModelAndView mv = new JModelAndView("user/default/usercenter/buyer_consult.html", configService.getSysConfig(),
		...
		qo.addQuery("obj.consult_user_id", new SysMap("consult_user", SecurityUserHolder.getCurrentUser().getId()), "=");
		qo.setPageSize(3);
