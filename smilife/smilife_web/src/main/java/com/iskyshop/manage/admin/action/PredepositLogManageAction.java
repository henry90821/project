...
public class PredepositLogManageAction {
	...
	public ModelAndView predepositlog_list(HttpServletRequest request, HttpServletResponse response, String currentPage,
			String orderBy, String orderType, String userName) {
		ModelAndView mv = new JModelAndView("admin/blue/predepositlog_list.html", configService.getSysConfig(),
		...
		if (this.configService.getSysConfig().isDeposit()) {
			...
			CommUtil.saveIPageList2ModelAndView(CommUtil.getURL(request) + "/admin/predepositlog_list.htm", "", params, pList, mv);
