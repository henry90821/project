...
public class GoodsCaseManageAction {
	...
	public ModelAndView goods_case_list(HttpServletRequest request, HttpServletResponse response, String currentPage,
			String orderBy, String orderType) {
		ModelAndView mv = new JModelAndView("admin/blue/goods_case_list.html", configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		String params = "";
		GoodsCaseQueryObject qo = new GoodsCaseQueryObject(currentPage, mv, orderBy, orderType);
		qo.setOrderBy("sequence");
		qo.setOrderType("asc");
		IPageList pList = this.goodscaseService.list(qo);
		CommUtil.saveIPageList2ModelAndView(CommUtil.getURL(request) + "/admin/goodscase_list.htm", "", params, pList, mv);
		return mv;
	}
	...
	public ModelAndView goods_case_add(HttpServletRequest request, HttpServletResponse response, String currentPage) {
	...
	public ModelAndView goods_case_save(HttpServletRequest request, HttpServletResponse response, String id,
			String currentPage, String cmd, String list_url, String add_url, String case_name, String display,
			String sequence, String case_id, String case_content) {
		...
		if (!StringUtils.isNullOrEmpty(case_content)) {
	...
	public void goods_case_ajax(HttpServletRequest request, HttpServletResponse response, String id, String fieldName,
	...
	public ModelAndView goods_case_goods(HttpServletRequest request, HttpServletResponse response, String currentPage,
	...
	public ModelAndView goods_case_gc(HttpServletRequest request, HttpServletResponse response, String currentPage) {
		ModelAndView mv = new JModelAndView("admin/blue/goods_case_gc.html", configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
	...
	public ModelAndView goods_case_goods_load(HttpServletRequest request, HttpServletResponse response, String currentPage,
			String gc_id, String goods_name) {
		ModelAndView mv = new JModelAndView("admin/blue/goods_case_goods_load.html", configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		...
		CommUtil.saveIPageList2ModelAndView(CommUtil.getURL(request) + "/admin/goods_case_goods_load.htm", "",
