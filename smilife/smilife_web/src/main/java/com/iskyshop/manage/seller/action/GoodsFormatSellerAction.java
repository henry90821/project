...
public class GoodsFormatSellerAction {
	...
	public ModelAndView goods_format_list(HttpServletRequest request, HttpServletResponse response, String currentPage,
			String orderBy, String orderType) {
		ModelAndView mv = new JModelAndView("user/default/sellercenter/goods_format_list.html", configService.getSysConfig(),
		...
		qo.addQuery("obj.gf_store_id", new SysMap("gf_store_id", store.getId()), "=");
	...
	public ModelAndView goods_format_add(HttpServletRequest request, HttpServletResponse response) {
		ModelAndView mv = new JModelAndView("user/default/sellercenter/goods_format_add.html", configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
	...
	public void goods_format_save(HttpServletRequest request, HttpServletResponse response, String id) {
		boolean ret = true;
		WebForm wf = new WebForm();
		if (StringUtils.isNullOrEmpty(CommUtil.null2String(id))) {
