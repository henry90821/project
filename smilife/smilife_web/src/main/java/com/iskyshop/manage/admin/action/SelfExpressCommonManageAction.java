...
public class SelfExpressCommonManageAction {
	...
	public ModelAndView ecc_set(HttpServletRequest request, HttpServletResponse response, String id) {
		ModelAndView mv = new JModelAndView("admin/blue/ecc_set.html", configService.getSysConfig(),
	...
	public ModelAndView ecc_save(HttpServletRequest request, HttpServletResponse response, String ids) {
		...
		for (String ec_id : ec_ids) {
			if (!"".equals(CommUtil.null2String(ec_id))) {
				...
				eccs = this.expressCompanyCommonService.query(
						"select obj from ExpressCompanyCommon obj where obj.ecc_ec_id=:ecc_ec_id and  obj.ecc_type=:ecc_type",
						params, -1, -1);
	...
	public ModelAndView ecc_list(HttpServletRequest request, HttpServletResponse response, String currentPage,
		...
		ModelAndView mv = new JModelAndView("admin/blue/ecc_list.html", configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
	...
	public void ecc_default(HttpServletRequest request, HttpServletResponse response, String id) {
		...
		if (!"".equals(CommUtil.null2String(id)) && obj.getEcc_type() == 1) {
			Map params = new HashMap();
			params.put("ecc_default", 1);
			params.put("ecc_type", 1);
			List<ExpressCompanyCommon> eccs = this.expressCompanyCommonService.query(
					"select obj from ExpressCompanyCommon obj where obj.ecc_default=:ecc_default and obj.ecc_type=:ecc_type",
					params, -1, -1);
			for (ExpressCompanyCommon ecc : eccs) {
	...
	public ModelAndView ecc_print_set(HttpServletRequest request, HttpServletResponse response, String id) {
		ModelAndView mv = new JModelAndView("admin/blue/ecc_print_set.html", configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		ExpressCompanyCommon obj = this.expressCompanyCommonService.getObjById(CommUtil.null2Long(id));
		if (obj.getEcc_type() == 1) {
	...
	public ModelAndView ecc_print_set_save(HttpServletRequest request, HttpServletResponse response, String id,
	...
	public ModelAndView ecc_create(HttpServletRequest request, HttpServletResponse response, String id) {
		ModelAndView mv = new JModelAndView("admin/blue/ecc_create.html", configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		ExpressCompanyCommon obj = this.expressCompanyCommonService.getObjById(CommUtil.null2Long(id));
	...
	public ModelAndView ecc_bind_defalut_template(HttpServletRequest request, HttpServletResponse response, String id,
		...
		if (obj != null && obj.getEcc_type() == 1) {
			...
			ModelAndView mv = new JModelAndView("admin/blue/success.html", configService.getSysConfig(),
					this.userConfigService.getUserConfig(), 0, request, response);
			mv.addObject("list_url", CommUtil.getURL(request) + "/admin/ecc_list.htm?currentPage=" + currentPage);
	...
	public ModelAndView ecc_design(HttpServletRequest request, HttpServletResponse response, String id, String currentPage) {
		ModelAndView mv = new JModelAndView("admin/blue/ecc_design.html", configService.getSysConfig(),
				this.userConfigService.getUserConfig(), 0, request, response);
		ExpressCompanyCommon obj = this.expressCompanyCommonService.getObjById(CommUtil.null2Long(id));
		if (obj != null && obj.getEcc_type() == 1) {
			Map offset_map = Json.fromJson(Map.class, CommUtil.null2String(obj.getEcc_template_offset()));
